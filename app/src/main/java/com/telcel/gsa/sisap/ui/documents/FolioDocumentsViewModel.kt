...
class FolioDocumentsViewModel(private val idFolio : String ,private val idEmployee: String) : ViewModel() {

    private val _documentsList = MutableLiveData<DocumentList>()
    val documentsList : LiveData<DocumentList>
    get() = _documentsList

    private val _downloadDocument = MutableLiveData<Int?>()
    val downloadDocument: LiveData<Int?>
    ...
    fun onDocumentClicked(id: Int){
        _downloadDocument.value = id
    }
